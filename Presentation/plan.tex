...
Il est donc possible avec cette propri\'et\'e de prouver le faux en partant du vrai. Donc elle rendrait \verifast{} incoh\'erent. \\ \par
	...
	\section{Quicksort}
		L'algorithme du Quicksort (voir annexe) doit \^etre l'un des algorithmes le plus connu et le plus utilis\'e. M\^eme si sa correction a \'et\'e d\'emontr\'ee de nombreuses fois, pour certifier un programme \verifast, tout le code doit \^etre prouv\'e avec \verifast. Il faut donc que les algorithmes les plus classiques soient de nouveau d\'emontr\'es. L'algorithme du Quicksort n'\'etait pas prouv\'e et \'etait un bon exemple pour illustrer l'int\'er\^et de la th\'eorie des tableaux.\par 
...
La sp\'ecification de $partition$ a \'et\'e d\'efinie ainsi :\\
		...
		-Preuve Fonction partition ?\\
		-Preuve fonction quicksort.\\
		-Lemme majore+minore+sorted+sorted = sorted
