...
*)
  ...
  let boxed_array = Printf.printf "declaring array boxing\n"; flush stdout; Z3.mk_func_decl ctxt (Z3native.mk_string_symbol ctxt "(arraybox)") [| array_type inductive_type inductive_type |] inductive_type in
  let unboxed_array = Printf.printf "declaring array unboxing\n"; flush stdout; Z3.mk_func_decl ctxt (Z3native.mk_string_symbol ctxt "(array)") [| inductive_type|] (array_type inductive_type inductive_type) in
