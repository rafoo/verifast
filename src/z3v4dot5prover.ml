...
*)
  ...
  let boxed_array a b= Z3.mk_func_decl ctxt (Z3native.mk_string_symbol ctxt "(arraybox)") [| array_type a b |] inductive_type in
  let unboxed_array a b = Z3.mk_func_decl ctxt (Z3native.mk_string_symbol ctxt "(array)") [| inductive_type|] (array_type a b) in
  ...
  object
    ...
    method mk_boxed_array a b t = Z3.mk_app ctxt (boxed_array a b) [| t |]
    method mk_unboxed_array a b t = Z3.mk_app ctxt (unboxed_array a b) [| t |]
